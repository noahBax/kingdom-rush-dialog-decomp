	...
	quest.encounters = {'combat_orcAmbush2_1','combat_orcAmbush2_2','combat_orcAmbush2_3','combat_orcAmbush2_4'}
	quest.tags = {"COMBAT","NORMAL","TERRAIN_WOODS"}
	...
	quest.AddCinematic("onReach", cinematicMapHelper.Cinematic({
									cinematicMapHelper.Instant(function ()
										...
										cinematicMapHelper.CurrentQuestStatus().encounters = cinematicMapHelper.RandomItem({{'combat_orcAmbush2_1'},{'combat_orcAmbush2_2'},{'combat_orcAmbush2_3'},{'combat_orcAmbush2_4'}});
									end)
								}))	
