do 
	...
	quest.encounters = {'combat_ghostTown'}
	quest.tags = {"COMBAT","HARD","TERRAIN_WOODS","TERRAIN_PLAINS"}
	...
	quest.AddCinematic("onReach", cinematicMapHelper.Cinematic({
									cinematicMapHelper.ConditionalIfElse(||(cinematicMapHelper.Guild().context.GetInt("linked.zombieTownQuest") == 1),
	...
	quest.AddCinematic("onWinCombat", cinematicMapHelper.Cinematic({
								cinematicMapHelper.ConditionalIfElse(||(cinematicMapHelper.Guild().context.GetInt("linked.zombieTownQuest") == 1),
									cinematicMapHelper.ShowRewards("MAP_RESULT_TITLE_VICTORY", || quest.results.questSuccess, || {}),
	...
	quest.results = {
		questSuccess = cinematicMapHelper.Result(|params| {
