do 
	...
	quest.encounters = {'combat_orcLooters_1','combat_orcLooters_2','combat_orcLooters_3','combat_orcLooters_4',}
	...
	quest.AddCinematic("onReach", cinematicMapHelper.Cinematic({
									cinematicMapHelper.Instant(function ()
										...
										cinematicMapHelper.CurrentQuestStatus().encounters = cinematicMapHelper.RandomItem({{'combat_orcLooters_1'},{'combat_orcLooters_2'},{'combat_orcLooters_3'},{'combat_orcLooters_4'}});
									end)
								}))
