do 
	...
	quest.encounters = {'combat_orcZogCamp_3','combat_orcZogCamp_32','combat_orcZogCamp_33'}
...
quest.AddCinematic("onReach", cinematicMapHelper.Cinematic({
									cinematicMapHelper.Instant(function ()
										if cinematicMapHelper.DarknessLevel()<=1 then 
											cinematicMapHelper.CurrentQuestStatus().encounters = {'combat_orcZogCamp_3'}
										elseif cinematicMapHelper.DarknessLevel() ==2 then
											cinematicMapHelper.CurrentQuestStatus().encounters = {'combat_orcZogCamp_32'}
										else 
											cinematicMapHelper.CurrentQuestStatus().encounters = {'combat_orcZogCamp_33'}
										end
									end)	
								}))
