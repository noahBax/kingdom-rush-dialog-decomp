do 
	...
	quest.id = 'ForestEmergentCombat'
	quest.encounters = {'combat_emergentForest1','combat_emergentForest2','combat_emergentForest3', 'combat_emergentForest4', 'combat_emergentForest5'}
	quest.tags = {"LINKED"}
	...
	quest.AddCinematic("onReach", cinematicMapHelper.Cinematic({
									...
									cinematicMapHelper.Instant(function ()
										...
										cinematicMapHelper.CurrentQuestStatus().encounters = cinematicMapHelper.RandomItem({{'combat_emergentForest1'},{'combat_emergentForest2'},{'combat_emergentForest3'},{'combat_emergentForest4'},{'combat_emergentForest5'}})
									end)
