...
encounterLogic.AddCinematic("OnStart",cinematicHelper.Cinematic({
		 ...
		 cinematicHelper.OverrideAnimation(|| cinematicHelper.FindCinematicUnit("Legend"), || "Crippled"),
