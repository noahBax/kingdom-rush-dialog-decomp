do 
	...
	quest.id = 'WastelandEmergentCombat2'
	quest.encounters = {'combat_emergentWasteland6','combat_emergentWasteland7','combat_emergentWasteland8','combat_emergentWasteland9','combat_emergentWasteland10'}
	quest.tags = {"LINKED"}
	...
	quest.AddCinematic("onReach", cinematicMapHelper.Cinematic({
									...
									cinematicMapHelper.Instant(function ()
										...
										cinematicMapHelper.CurrentQuestStatus().encounters = cinematicMapHelper.RandomItem({{'combat_emergentWasteland6'},{'combat_emergentWasteland7'},{'combat_emergentWasteland8'},{'combat_emergentWasteland9'},{'combat_emergentWasteland10'}})
									end)
