do 
	...
	quest.id = 'VillagePeril'
	quest.visual = "Orc"
	quest.kindFlag = "Combat"
	quest.encounters = {'combat_villagePeril_1','combat_villagePeril_2','combat_villagePeril_3','combat_villagePeril_4'}
	quest.tags = {"COMBAT","EASY","TERRAIN_PLAINS"}
	...
	quest.AddCinematic("onReach", cinematicMapHelper.Cinematic({
									cinematicMapHelper.Instant(function ()
										...
										cinematicMapHelper.CurrentQuestStatus().encounters = cinematicMapHelper.RandomItem({{'combat_villagePeril_1'},{'combat_villagePeril_2'},{'combat_villagePeril_3'},{'combat_villagePeril_4'}});
									end)
								}))									
