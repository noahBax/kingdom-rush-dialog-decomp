...
do 
	...
	quest.id = 'TownBrawlYeti'
	quest.visual = "Tavern"
	quest.kindFlag = "Combat"
	quest.encounters = {'combat_townBrawlYeti'}
						    ...
						    {
						        {
						            ...
						            text = || __D(2, "A group of yetis is attacking the village of Argaleham!"),
						            who = || "mapCinematicId",
						    		icon = || "Asst_Mountain",
						    		children = {
						    			{
	...
	quest.AddCinematic("onWinCombat", cinematicMapHelper.Cinematic({
								...
								cinematicMapHelper.AchievementIncrement(|| "all_argaleham_wins",|| 1,|| 0),
		 						cinematicMapHelper.Instant(function()
