						    ...
						    {
						        {
						            ...
						            narrator = || __N(1, "Krum's Throne Rush!"),
						            
						            text = || __D(2, "The grasslands have been invaded by bloodlusting orcs led by their dreadful leader, Krum'Thak Ragestorm.\n\nIt's up to us to rush the shaman's throne and put an end to the orcish invasion!"),
	...
	quest.AddCinematic("onReach", cinematicMapHelper.Cinematic({
									cinematicMapHelper.Instant(function ()
										if cinematicMapHelper.IsDifficultyEasy() then
											cinematicMapHelper.OverrideInventory({"food","food","food","food","food","food","food","food","food","elixirOfLife","elixirOfLife","elixirOfLife","tent","tent","tent","coffee","coffee","coffee","rope","rope","rope","pick","pick","pick"})
									...
									cinematicMapHelper.ShowComic("ComicForestIntro"),
