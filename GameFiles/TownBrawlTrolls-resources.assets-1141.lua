...
do 
	...
	quest.id = 'TownBrawlTrolls'
	quest.visual = "Tavern"
	quest.kindFlag = "Combat"
	quest.encounters = {'combat_townBrawlTrolls'}
						    ...
						    {
						        {
						            ...
						            text = || __D(2, "A band of trolls is attacking the village of Argaleham!"),
						            who = || "mapCinematicId",
						    		icon = || "Asst_Mountain",
						    		children = {
						    			{
	...
	quest.AddCinematic("onWinCombat", cinematicMapHelper.Cinematic({
								...
								cinematicMapHelper.AchievementIncrement(|| "all_argaleham_wins",|| 1,|| 1),
		 						cinematicMapHelper.Instant(function()
