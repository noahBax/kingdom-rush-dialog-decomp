...
"MAP_RESULTS_GENERIC_STAT_MOD_armor_max_UP" = "{0}'s armour has improved"
"MAP_RESULTS_GENERIC_STAT_MOD_armor_max_DOWN" = "{0}'s armour has worsened"
...
"MAP_RESULTS_GENERIC_STAT_MOD_armor_max_PARTY_UP" = "Party's armour has improved"
"MAP_RESULTS_GENERIC_STAT_MOD_armor_max_PARTY_DOWN" = "Party's armour has worsened"
...
"STAT_armor_max_TITLE" = "Max Armour"
"STAT_armor_max_DESCRIPTION" = "The maximum amount of armour a hero can have initially."
...
"STAT_STORE_armor_max_TITLE" = "Armoursmith"
...
"STAT_STORE_armor_max_TEXT_REPAIRABLE" = "Your armour is bust! Let me help."
"STAT_STORE_armor_max_TEXT_UPGRADEABLE" = "Want me to improve your armour?"
"STAT_STORE_armor_max_TEXT_MAXED" = "Your armour is maxed out!"
...
"UNIT_MINION_FEMALE_KNIGHT_LORE" = "The heavily armoured knights can withstand the fiercest of blows, making them a resilient and hard-hitting force to be reckoned with."
...
"UNIT_MINION_DARKKNIGHT_LORE" = "Dark Knights are the backbone of the Dark Army.\nHaving traded their vitality for great unholy powers, they have resorted to wearing heavy armour to compensate for their poor constitution."
"UNIT_MINION_BARBARIAN_NAME_0001" = "Barbarian"
"UNIT_MINION_BARBARIAN_LORE" = "The hulking barbarians rush into battle with little to no armour, preferring mobility over protection and attack over defence."
"UNIT_MINION_ARCANE_MAGE_NAME_0001" = "Arcane Wizard"
"UNIT_MINION_ARCANE_MAGE_LORE" = "Arcane mages are expert spellcasters who focus on dealing great armour-piercing damage from long distances."
...
"UNIT_PROP_SULFURIC_BLAST_NAME_0001" = "Sulphuric Blast"
...
"LOADING_SCREEN_TIPS_0003" = "Having a varied party does wonders. Try different configurations until you find your favourite."
...
"LOADING_SCREEN_TIPS_0015" = "If your party relies on armoured characters, make sure that you target magic users first."
...
"LOADING_SCREEN_TIPS_0021" = "Rooted, asleep, stunned, and frozen characters are considered IMMOBILISED."
...
"COMIC_FOREST_INTRO_PAGE1_BALLOON2A" = "DARK ARMY MARCHES OTHER WAY. GRASSLAND IS FOR ORCS TO TAKE!"
...
"TUTORIAL_NOTIFICATION_DUNGEON_3_1_TITLE" = "Armour and HP damage:"
"TUTORIAL_NOTIFICATION_DUNGEON_3_1_TEXT" = "Physical damage is first applied to a unit's armour.\nTo defeat a unit, you will need to exhaust their HP bar.\nCombat ends when all units on one side are defeated."
...
"TUTORIAL_NOTIFICATION_RANGED_1_2_TEXT" = "Most units have special traits.\nThe ranger's agility trait enables him to use his move action before or after using a simple action."
...
"ITEM_pick_NAME" = "Pick"
"ITEM_pick_DESCRIPTION" = "Whether you're digging, tunnelling, or breaking stuff, choose a pick for the job.\n\n<style="extra">Challenge Item</style>"
...
"ITEM_armorersKit_NAME" = "Armourer's Repair Kit"
"ITEM_armorersKit_DESCRIPTION" = "Increases target character's armour by <style="buff">+{increase}</style>.\n\n<style="extra">Max Improvement:+{maxIncrease}\nConsumable</style>"
...
"ACHIEVEMENT_sorceress_unlock_NAME" = "Friendly Neighbourhood"
...
"ACHIEVEMENT_loot_collector_DESC" = "Gain {calcTotal} gold during an adventure."
...
"ACHIEVEMENT_heal_total_count_DESC" = "Heal by {calcTotal} health points during combats."
...
"COMBAT_MODIFIER_generic_modifier_summoned_DESCRIPTION" = "This is a summoned unit, and it will disappear once its duration expires or its summoner summons a new unit."
...
"COMBAT_MODIFIER_regson_eldritch_state_modifier_DESCRIPTION" = "Reg'son channels his eldritch energy and will add effects to certain skills."
...
"COMBAT_MODIFIER_regson_focus_state_modifier_TITLE" = "Channelling"
...
"COMBAT_MODIFIER_modifier_knight_hold_the_line_TITLE" = "Armoured"
"COMBAT_MODIFIER_modifier_knight_hold_the_line_DESCRIPTION" = "This unit has improved armour."
...
"COMBAT_MODIFIER_demon_lord_nethershield_modifier_DESCRIPTION" = "This unit has improved armour."
...
"COMBAT_MODIFIER_darkknight_spike_reforge_modifier_DESCRIPTION" = "Armour of Thorns damage is enhanced."
...
"COMBAT_MODIFIER_mighty_endturn_trait_modifier_active_DESCRIPTION" = "This unit has +{extraArmor} armour for this turn."
...
"SKILL_common_bite_attack_DESCRIPTION" = "Bites the target to deal damage."
...
"SKILL_krum_trigger_lightning_ability_DESCRIPTION" = "Marks several areas to strike with a thunderbolt during the next turn.\nThe strike deals high damage at its centre and splash damage with <style="concept">knockback</style> to units in the adjacent hexes."
...
"SKILL_snapvine_attack_DESCRIPTION" = "Lands a quick bite on the target to deal damage."
...
"SKILL_spiderling_melee_attack_DESCRIPTION" = "Bites the target to deal damage."
...
"SKILL_spider_poison_spit_DESCRIPTION" = "Spits poison at a target from afar, dealing damage and applying <style="debuff">poisoned</style>."
...
"SKILL_winter_wulf_bite_DESCRIPTION" = "Bites the target to deal damage."
...
"SKILL_yeti_snowball_throw_DESCRIPTION" = "Throws a snowball at a target, damaging it and all units within a {aoeRadius}-hex radius.\nMain target gets <style="concept">rooted</style>."
...
"SKILL_infernal_sacrifice_DESCRIPTION" = "At <style="highlight">{healthValue} HP</style>, runs towards the closest target and explodes, damaging all adjacent units."
...
"SKILL_demon_lord_nethershield_DESCRIPTION" = "Shielding spell that raises the armour of all allied units within a {aoeRadius}-hex radius."
"SKILL_demon_lord_nethershield_DESCRIPTION_DATA" = "Extra armour: <style="buff">+{armorBonus} {icon#statArmor}</style>\nRange: <style="highlight">SELF</style>"
...
"SKILL_mbf_ulgukhai_maze_swing_DESCRIPTION" = "Performs a circular attack affecting all enemies within a {aoeRadius}-hex radius."
...
"SKILL_mbf_ulgukhai_charge_DESCRIPTION" = "Charges towards its target in a straight line, damaging all units in its path.\nAll struck units are randomly dropped into the free hexes around Ulguk-Hai."
...
"SKILL_darkknight_armor_of_thorns_trait_NAME" = "Armour of Thorns"
...
"SKILL_regson_eldritch_syphon_trait_NAME" = "Eldritch Siphon"
...
"SKILL_mighty_endturn_trait_DESCRIPTION" = "Gains extra armour until the next turn if the character ends their turn without using any skills."
"SKILL_mighty_endturn_trait_DESCRIPTION_DATA" = "Extra armour: <style="buff">+{extraArmor} {icon#statArmor}</style>"
"SKILL_athletics_endturn_trait_NAME" = "Keen Focus"
"SKILL_athletics_endturn_trait_DESCRIPTION" = "Gains extra damage until the next turn if the character ends their turn without using any skills."
...
"SKILL_skeleton_re_assemble_trait_DESCRIPTION" = "Once per combat, returns to life after <style="highlight">{turns} {icon#turns}</style> if HP reaches 0."
...
"SKILL_gerald_swing_DESCRIPTION" = "Strikes an enemy with a swing of the blade, dealing damage."
...
"SKILL_gerald_divine_blade_DESCRIPTION_EPIC" = "<style="epic">EPIC:</style> Deals bonus damage against <style="concept">immobilised</style> targets."
...
"SKILL_gerald_rally_DESCRIPTION" = "Gerald rallies all allies within a {aoeRadius}-hex radius, removing all <style="debuff">debuffs</style> when cast and improving walking speed."
...
"SKILL_gerald_martyrs_inspiration_DESCRIPTION" = "Gerald spends HP to inspire allies within a {aoeRadius}-hex radius, boosting their attack and damage reduction."
...
"SKILL_arrow_of_sorrow_DESCRIPTION_EPIC" = "<style="epic">EPIC:</style> Deals <style="highlight">true damage</style> against <style="concept">immobilised</style> targets."
...
"SKILL_asra_shiv_DESCRIPTION" = "Meticulous stab that deals heavy damage to the target's armour."
...
"SKILL_bruxa_voodoo_blow_DESCRIPTION_EPIC" = "<style="epic">EPIC:</style> Deals damage to <style="concept">immobilised</style> enemies."
...
"SKILL_regson_vicious_lounge_DESCRIPTION" = "Lunges towards an enemy to deal damage, landing on an adjacent free hex afterwards."
...
"SKILL_regson_blood_veil_DESCRIPTION" = "Spends HP to cast a shield for himself that will negate all damage from the next hit."
...
"SKILL_regson_vindicator_DESCRIPTION" = "Hits the target with a revenge-fuelled strike that deals double his missing health as damage and then restores some HP."
...
"SKILL_regson_eldritch_fury_DESCRIPTION" = "Fully heals himself and enters a focus state. Starts the next turn by dealing damage to all adjacent enemies equal to his missing HP, and losing the focus state."
...
"SKILL_knight_gain_terrain_DESCRIPTION_EPIC" = "<style="epic">EPIC:</style> Bonus damage against <style="concept">immobilised</style> targets."
...
"SKILL_knight_hold_the_line_DESCRIPTION" = "Lets out an encouraging battle cry that raises the armour of all allies within a {aoeRadius}-hex radius and removes <style="concept">asleep</style>."
"SKILL_knight_hold_the_line_DESCRIPTION_DATA" = "Extra armour: <style="buff">+{extraArmor} {icon#statArmor}</style>\nDuration: <style="buff">{duration} {icon#turns}</style>\nRange: <style="highlight">SELF</style>"
"SKILL_charge_NAME" = "Charge"
"SKILL_charge_DESCRIPTION" = "Charges towards a free hex, damaging and applying <style="debuff">bleeding</style> to all enemies caught in the way."
...
"SKILL_ranger_precise_shot_DESCRIPTION_EPIC" = "<style="epic">EPIC:</style> Bonus damage against <style="concept">immobilised</style> targets."
...
"SKILL_sorceress_corroding_hex_DESCRIPTION" = "Casts a spell that drains the target's armour."
"SKILL_sorceress_corroding_hex_DESCRIPTION_EPIC" = "<style="epic">EPIC:</style> If the spell reduces the armour to 0, the destroyed armour goes to the sorceress."
...
"SKILL_stormcloud_high_sorcerer_summon_golem_DESCRIPTION" = "Summons a brawny stone golem to fight on his side."
...
"SKILL_solidify_DESCRIPTION" = "Fully restores armour."
...
"SKILL_telekinesis_DESCRIPTION" = "Pulls the target {pullValue} hex towards his current position.\nIf the target is adjacent, it gets pushed {pushValue} hex away instead."
...
"SKILL_brutal_strike_DESCRIPTION_EPIC" = "<style="epic">EPIC:</style> Applies <style="debuff">bleeding</style> to <style="concept">immobilised</style> targets."
...
"SKILL_leap_DESCRIPTION" = "Leaps into the air to land in a free hex, dealing damage and applying <style="concept">knockback</style> and <style="concept">stunned</style> to all enemies within a {aoe}-hex radius."
...
"SKILL_barbarian_wrecking_roll_DESCRIPTION" = "Rolls towards a free hex up to {distanceToTravel} hexes away, dealing damage and applying <style="concept">stunned</style> to all units in the way."
...
"SKILL_cleaver_slash_DESCRIPTION_EPIC" = "<style="epic">EPIC:</style> Deals bonus damage against <style="debuff">immobilised</style> targets."
...
"SKILL_cleaver_brutal_strike_DESCRIPTION_EPIC" = "<style="epic">EPIC:</style> Applies <style="debuff">bleeding</style> to <style="concept">immobilised</style> targets."
...
"SKILL_darkknight_impervious_DESCRIPTION" = "Fully restores armour and gains <style="buff">extra armour</style>.\nRemoves <style="debuff">burning</style> and <style="debuff">poisoned</style> status."
"SKILL_darkknight_impervious_DESCRIPTION_DATA" = "Extra armour: <style="buff">+{armorBonus} {icon#statArmor}</style>\nDuration: <style="highlight">{duration} {icon#turns}</style>\nRange: <style="highlight">SELF</style>"
"SKILL_darkknight_spike_reforge_NAME" = "Spike Reforge"
"SKILL_darkknight_spike_reforge_DESCRIPTION" = "Fully restores armour and gains extra <style="damage">thorns damage</style>."
...
"SKILL_darkknight_porcupine_slam_DESCRIPTION" = "Projects his armour's thorns, damaging all enemies within a {aoeRadius}-hex radius."
...
"SKILL_shortfuse_DESCRIPTION_EPIC" = "<style="epic">EPIC:</style> Bonus damage against <style="concept">immobilised</style> targets."
...
"SKILL_tesla_jolt_DESCRIPTION_EPIC" = "<style="epic">EPIC:</style> Applies <style="debuff">burning</style> to <style="concept">immobilised</style> units."
...
"SKILL_sasquatch_ground_spike_DESCRIPTION" = "Raises a ground spike below the target, which deals damage and <style="concept">pulls</style> the target {pull} hex towards the Sasquatch."
...
"TUTORIAL_GUIDED_TVOS_SWITCH_MODE" = "Press Play/Pause on the remote to switch between the Battle grid and Action buttons."
...
"HERO_RANK_DESC" = "The level of mastery using this character. Unlocks new skill variants as you gain a higher rank."
...
"TUTORIAL_GUIDED_GAMEPAD_SWIPE_ATTACK" = "Move the stick to select an enemy to attack."
"TUTORIAL_GUIDED_GAMEPAD_SWIPE_END_TURN" = "Move the stick to select End Turn."
"TUTORIAL_GUIDED_GAMEPAD_SWIPE_GET_CLOSER" = "Move the stick to select a hex and get closer to the enemy."
"TUTORIAL_GUIDED_GAMEPAD_SWITCH_MODE" = "Press the button to switch between the Battle grid and Action buttons."
...
"LANGUAGE_NAME_LOCALIZED" = "English (UK)"
"DIFFICULTY_CHOOSE_TITLE" = "SELECT DIFFICULTY"
"DIFFICULTY_CHOOSE_INTRO" = "Legends of Kingdom Rush can be a challenging game, so expect to lose a few times while you grasp its mechanics."
...
"PROGRESSION_HELP_POPUP_LEVEL_EARN" = "Earn XP orbs by facing combats and events during the adventure."
...
"PROGRESSION_HELP_POPUP_LEVEL_RESET" = "Character levels reset at the start of each adventure, so you can have a fully fresh experience from beginning to end."
"PROGRESSION_HELP_POPUP_RANK_TITLE" = "Character Rank-ups"
"PROGRESSION_HELP_POPUP_RANK_INTRO" = "Based on your performance, your party members also gain permanent rank levels at the end of each adventure, whether it ends in a victory or a defeat. Ranking up unlocks new powers to use during adventures."
...
"ACHIEVEMENT_adventure_completed_forest_normal_DESC" = "Complete Krum'Thak's Dominion at Normal difficulty."
"ACHIEVEMENT_adventure_completed_mountain_normal_NAME" = "Stormcloud's Spring"
"ACHIEVEMENT_adventure_completed_mountain_normal_DESC" = "Complete Stormcloud's Winter at Normal difficulty."
"ACHIEVEMENT_adventure_completed_wasteland_normal_NAME" = "Not so menacing"
"ACHIEVEMENT_adventure_completed_wasteland_normal_DESC" = "Complete Extradimensional Menace at Normal difficulty."
"ADVENTURE_BRIEF_silveroak_TITLE" = "The Wild Moon"
"ADVENTURE_BRIEF_silveroak_DESCRIPTION" = "A hatred of outsiders has driven the Ashervan, a coven of Sylvan Elf enchantresses and warlocks, to summon a powerful evil forest spirit called Mór-Ga-Nok.\n\nAfter possessing the Argentree, the forest’s natural life source, Mór-Ga-Nok started pumping its own evil energy into the forest to create an army of wicked treefolk, in order to quench its thirst for destruction by conquering the realm. Whatever the cost."
...
"SKILL_silveroak_sylvan_awareness_DESCRIPTION" = "This unit is immune to <style="debuff">asleep</style> status."
...
"SKILL_enchantress_spore_shower_DESCRIPTION" = "Showers an adjacent target with armour-corroding spores that apply <style="debuff">poisoned</style> and <style="debuff">asleep</style>."
...
"SKILL_warlock_sunder_armor_NAME" = "Sunder Armour"
"SKILL_warlock_sunder_armor_DESCRIPTION" = "The warlock shreds his target's armour with his mighty claws."
...
"SKILL_silveroak_inflammable_trait_DESCRIPTION" = "Receives +{extraBurnDamage} damage from the effect of <style="debuff">burning</style> status."
...
"SKILL_vinepaw_bite_DESCRIPTION" = "Bites the target to deal damage."
...
"SKILL_vinepaw_headbutt_DESCRIPTION" = "Runs towards its target and rams it with its antlers, dealing damage and applying <style="concept">knockback</style>."
...
"SKILL_sbf_aspect_shield_trait_DESCRIPTION" = "When the HP of one aspect of Mór-Ga-Nok drops to 0, it gains a shield that renders it invulnerable to all damage.\nThe shield is destroyed once all aspects' HP is less than {shield_activation_health}."
...
"SKILL_sbf_aspect_magic_attack_DESCRIPTION" = "Casts magic mist in three directions up to {range} hexes away, damaging and applying <style="debuff">asleep</style> to all enemies caught in it."
...
"COMIC_SILVEROAK_INTRO_PAGE1_BALLOON1" = "ON THE OUTSKIRTS OF SILVEROAK FOREST"
...
"SKILL_sylvan_elf_spear_rush_DESCRIPTION" = "The elf rushes towards his target and pierces both the enemy and the one behind them with his lance."
...
"SKILL_spike_spinner_attack_DESCRIPTION" = "The artefact extends deadly spikes and starts spinning, dealing damage and applying <style="concept">knockback</style> to all units within a {aoeRadius}-hex area."
...
"ARENA_DIVERSIFIER_orcish_forge_DESCRIPTION" = "All enemies have improved armour from the start of the combat."
"ARENA_DIVERSIFIER_orcish_forge_DESCRIPTION_DATA" = "Extra armour: <style="buff">+{extra_armor} {icon#statArmor}</style>"
"ARENA_DIVERSIFIER_orcish_forge_DESCRIPTION_EXTRA" = "<style="extra">No change in the units' armour regeneration.</style>"
...
"ARENA_DIVERSIFIER_fans_favourite_NAME" = "Fans' Favourite"
...
"ACHIEVEMENT_qpa_fast_win_burning_desire_DESC" = "Win a Quick-Play Arena combat with the Burning Desire diversifier in {round} rounds or fewer.\n<i>(arena-only achievement)</i>"
...
"AREA_HELP_POPUP_QPC_RANDOMIZE" = "You can re-roll to get a different combination of scenario, heroes, and diversifiers by pressing the RANDOMISE button."
...
"UI_ARENA_DAILY_STATUS_LOGIN_GAMECENTER" = "Please sign in to the Game Center."
"DEMO_BANNER" = "Demo"
