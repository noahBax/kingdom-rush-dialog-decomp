...
encounterLogic.AddCinematic("OnStart",cinematicHelper.Cinematic({
		...
		cinematicHelper.ShowComment(|| "hero01", || __C(1, "As the old\nsaying goes..."), 1.6), 
		...
		cinematicHelper.ShowComment(|| "hero02", || __C(2, "Not again..."), 1.6), 
		cinematicHelper.Instant(|| cinematicHelper.PlayInstantAnimation(cinematicHelper.FindCinematicUnit("hero02"),"Speak")),
		cinematicHelper.Sleep(1.8),

		cinematicHelper.ShowComment(|| "hero01", || __C(3, "Never split up the party."), 1.8), 
		cinematicHelper.Instant(|| cinematicHelper.PlayInstantAnimation(cinematicHelper.FindCinematicUnit("hero01"),"Speak")),
		cinematicHelper.Sleep(2),

		cinematicHelper.ShowComment(|| "hero02", || __C(4, "*Sigh*"), 1.2), 
		
		cinematicHelper.Sleep(1.6),

		cinematicHelper.ShowComment(|| "Legend", || __C(5, "Less talk,\nmore fight."), 1.6), 
