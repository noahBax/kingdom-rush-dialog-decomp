...
encounterLogic.AddCinematic("OnStart",cinematicHelper.Cinematic({
		 ...
		 cinematicHelper.ShowComment(|| "Legend", || __C(1, "What's all this ...\ncorruption?"), 2.4), 
		 ...
		 cinematicHelper.ShowComment(|| "cultist01", || __C(2, "This?"), 1.6), 
		 cinematicHelper.Sleep(2.2),

		 cinematicHelper.Instant(|| cinematicHelper.PlayInstantAnimation(cinematicHelper.FindCinematicUnit("cultist01"),"SpecialAttack")),
		 cinematicHelper.ShowComment(|| "cultist01", || __C(3, "This will be our\nnew world!"), 2.6), 
		 cinematicHelper.Sleep(2.4),
