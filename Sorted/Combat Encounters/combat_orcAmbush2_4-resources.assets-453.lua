...
encounterLogic.AddCinematic("OnStart",cinematicHelper.Cinematic({
		 ...
		 cinematicHelper.Parallel({
			...
			cinematicHelper.Sequence({	
				...
				cinematicHelper.ShowComment(|| "orc03", || __C(2, "Thak!"), 2),
				cinematicHelper.Sleep(1.0),
			}),	
			cinematicHelper.Sequence({	
				...
				cinematicHelper.ShowComment(|| "orc04", || __C(3, "Thak!"), 2),
				cinematicHelper.Sleep(1.0),
			}),	
			cinematicHelper.Sequence({	
				...
				cinematicHelper.ShowComment(|| "orc02", || __C(4, "Thak!"), 2),
				cinematicHelper.Sleep(1.0),
			}),	
			cinematicHelper.Sequence({	
						cinematicHelper.Sleep(1),
						cinematicHelper.ShowComment(|| "HeroUnit", || __C(5, "This will be legen..."), 2),
