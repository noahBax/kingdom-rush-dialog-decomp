	   ...
	   cinematicHelper.SetCinematicBarsVisibility(true),
		...
		cinematicHelper.ConditionalIf(|| cinematicHelper.UnitExists("Bravebark"),
			 cinematicHelper.Sequence({
				 ...
				 cinematicHelper.ShowComment(|| "Bravebark", || __C(29, "They live on in me,"), 1.5), 
				 cinematicHelper.Sleep(1.5),
				 cinematicHelper.Instant(|| cinematicHelper.PlayInstantAnimation(cinematicHelper.FindCinematicUnit("Bravebark"),"Speak")),
				 cinematicHelper.ShowComment(|| "Bravebark", || __C(30, "but you will die."), 2), 
				 cinematicHelper.Sleep(2.3),
			  })),
		cinematicHelper.ConditionalIf(|| cinematicHelper.UnitExists("Reg'son"),
			  cinematicHelper.Sequence({
				   
				   cinematicHelper.Instant(|| cinematicHelper.PlayInstantAnimation(cinematicHelper.FindCinematicUnit("enemy06"),"Speak")),
				  cinematicHelper.ShowComment(|| "enemy06", || __C(26, "Reg'son...\n"), 1), 
				  cinematicHelper.Sleep(1.2),
				  cinematicHelper.Instant(|| cinematicHelper.PlayInstantAnimation(cinematicHelper.FindCinematicUnit("enemy06"),"Speak")),
				  ...
				  cinematicHelper.Sleep(2.5),
				  cinematicHelper.Instant(|| cinematicHelper.PlayInstantAnimation(cinematicHelper.FindCinematicUnit("Reg'son"),"Speak")),
				  cinematicHelper.ShowComment(|| "Reg'son", || __C(29, "I saved my\nkingdom once,"), 1.5), 
				  cinematicHelper.Sleep(1.5),
				  cinematicHelper.Instant(|| cinematicHelper.PlayInstantAnimation(cinematicHelper.FindCinematicUnit("Reg'son"),"Speak")),
				  cinematicHelper.ShowComment(|| "Reg'son", || __C(30, "I will save\nLinirea too."), 2), 
				  cinematicHelper.Sleep(2.3),
			   })),
		cinematicHelper.Parallel({
