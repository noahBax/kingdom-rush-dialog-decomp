...
encounterLogic.AddCinematic("OnStart",cinematicHelper.Cinematic({
		 ...
		 cinematicHelper.ShowComment(|| "cultist01", || __C(1, "So, the trolls\nfailed to stop you...."), 2.8), 
		 cinematicHelper.Sleep(3.2),

		 cinematicHelper.Instant(|| cinematicHelper.PlayInstantAnimation(cinematicHelper.FindCinematicUnit("Legend"),"Speak")),
		 cinematicHelper.ShowComment(|| "Legend", || __C(2, "And it won't be\ndifferent with you!"), 2.8), 
